...
## Research Stack & Tools

- **Frameworks & Languages**: Python, PyTorch, PyTorch Geometric (PyG), Flower (FL Framework), Scikit-Learn, XGBoost.
- **Security & IoT**: Network Packet Analysis, Edge-IIoTset Benchmark, Intrusion Detection Systems (IDS).
- **Web & Tools**: Jekyll, Git/GitHub, Markdown, LaTeX, VS Code.
